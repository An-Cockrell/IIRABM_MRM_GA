...
data=np.load('ARDS_Pos_D6_10_Norm.npy')
normalize=1;

mmfile1='MinMax/Mins_Pos_Norm'
mmfile2='MinMax/Maxs_Pos_Norm'
ipfile='InternalParameterization_Pos_Norm'
nvfile='NumViable_Pos_Norm'
fitfile='Fitness_Pos_Norm'
