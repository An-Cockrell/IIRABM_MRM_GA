...
data=np.load('ARDS_Neg_D6_10_Norm.npy')
normalize=1;

mmfile1='MinMax/Mins_Neg_Norm'
mmfile2='MinMax/Maxs_Neg_Norm'
ipfile='InternalParameterization_Neg_Norm'
nvfile='NumViable_Neg_Norm'
fitfile='Fitness_Neg_Norm'
