...
#    print(rank,tnfResult)
    ...
    print(rank,"TNF",tnfResult)
    print(rank,"IL4",il4Result)
    print(rank,"IL10",il10Result)
    print(rank,"GCSF",gcsfResult)
    print(rank,"IFNG",ifngResult)
...
for i in range(numIters):
    ...
    myFitness,MNS,MXS=getFitness(numStochasticReplicates,myIP,injSize)
    mnFile=str('MinMax/Mins_%s_%s.csv'%(i,rank))
    mxFile=str('MinMax/Maxs_%s_%s.csv'%(i,rank))
